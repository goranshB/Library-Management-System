...
public class BooksForm extends JFrame {
	...
	public BooksForm() {
		...
		lblAddBooks.setFont(new Font("Franklin Gothic Medium", Font.PLAIN, 22));
		...
		btnAddBooks.setFont(new Font("Arial Narrow", Font.BOLD, 15));
		JButton btnBack = new JButton("BACK");
			...
			public void actionPerformed(ActionEvent e) {
                ...
                btnBack.setFont(new Font("Arial Narrow", Font.BOLD, 13));
