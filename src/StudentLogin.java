...
public class StudentLogin extends JFrame {
	...
	public StudentLogin() {
		...
		JLabel lblStudentLoginForm = new JLabel("   STUDENT LOGIN   ");
		lblStudentLoginForm.setForeground(Color.WHITE);
		lblStudentLoginForm.setFont(new Font("Franklin Gothic Medium", Font.PLAIN, 25));
		
		JLabel lblEnterName = new JLabel("Enter Name:");
                lblEnterName.setForeground(Color.WHITE);
		lblEnterName.setFont(new Font("Franklin Gothic Medium", Font.PLAIN, 25));
		
		JLabel lblEnterPassword = new JLabel("Enter Password:");
                 lblEnterPassword.setForeground(Color.WHITE);
		lblEnterPassword.setFont(new Font("Franklin Gothic Medium", Font.PLAIN, 25));
