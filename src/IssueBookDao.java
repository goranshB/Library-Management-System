...
/*public static int save(String bookcallno,int studentid,String studentname,String studentcontact,String IS,String Rn){
	...
	try{
		...
		if(status>0){
		PreparedStatement ps=con.prepareStatement("insert into issuebooks(bookcallno,studentid,studentname,studentcontact,issueddate,returndate,duedays) values(?,?,?,?,?,?,?)");
		ps.setString(1,bookcallno);
 ...
 public static int save(String bookcallno, int studentid, String studentname, String studentcontact, String IS, String Rn) {
        ...
        try {
            ...
            if (status > 0) {
                ...
                ps.setString(5, IS);
                ps.setString(6, Rn);
                ps.setInt(7, (int) diffInDays); // Set the difference in days as duedays
                
                
                PreparedStatement ps1 = con.prepareStatement("insert into perma(bookcallno,studentid,studentname,studentcontact,issueddate,returndate,duedays) values(?,?,?,?,?,?,?)");
